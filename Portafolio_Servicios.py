...
# --- 3. CSS PREMIUM (CORREGIDO Y OPTIMIZADO) ---
st.markdown(f"""
<style>
    /* IMPORTAR FUENTE */
    ...
    .custom-modal-box {{
        ...
        margin-top: -20px; /* Ajuste para subir contenido */
    }}
...
# ==============================================================================
# --- 4. DEFINICIÓN DE MODALES (SOLUCIÓN A RENDERING) ---
# ==============================================================================

@st.dialog("📊 INVENTARIOS & ESTRATEGIA")
def open_inventory_modal():
    # NOTA: EL HTML ESTÁ ALINEADO A LA IZQUIERDA PARA EVITAR QUE STREAMLIT LO LEA COMO CÓDIGO
    st.markdown("""
